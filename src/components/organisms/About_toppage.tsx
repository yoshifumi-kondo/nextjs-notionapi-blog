...
import SNSbar from '@/components/organisms/SNSbar';
  ...
  return (
    <div className='border-8 border-slate-700 rounded-lg shadow bg-white w-full p-8'>
      <div className='flex flex-col justify-between md:flex-row'>
        ...
        <div className='flex md:mt-0 mt-4 md:flex-col justify-center gap-2 md:gap-1 md:justify-around items-end w-full md:w-fit'>
          <SNSbar color='yellow' />
        </div>
      </div>
    </div>
